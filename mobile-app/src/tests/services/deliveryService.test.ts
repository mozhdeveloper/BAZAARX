/**
 * DeliveryService — Mobile Unit Tests
 *
 * Covers:
...
describe('DeliveryService (Mobile)', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe('cancelDelivery', () => {
    it('should cancel a booked delivery', async () => {
      mockFromMultiple([
        { data: { status: 'booked', order_id: ORDER_ID } },
        { data: { id: BOOKING_ID } },
        { data: { id: 'event-001' } },
        { data: { id: BOOKING_ID } },
        { data: { id: ORDER_ID } },
  ...
  describe('sandboxAdvanceStatus', () => {
    it('should advance from booked to pickup_scheduled', async () => {
      mockFromMultiple([
        ...
        { data: { id: BOOKING_ID } },
        { data: { id: 'event-001' } },
        { data: { id: BOOKING_ID, order_id: ORDER_ID } },
        { data: { id: ORDER_ID } },
        { data: { id: 'history-001' } },
      ]);
