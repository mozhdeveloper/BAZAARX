...
type Props = NativeStackScreenProps<RootStackParamList, 'SellerEmailVerification'>;
...
export default function SellerEmailVerificationScreen({ navigation, route }: Props) {
    ...
    const checkStatus = async (isManual = false) => {
        ...
        if (!isManual && appStateRef.current !== 'active') {
            return;
        }
        ...
        try {
            ...
            if (isVerified) {
                ...
                const finalSignupData = signupData || useAuthStore.getState().pendingSignupData;
                console.log('[SellerEmailVerification] Navigating to finalize with signupData:', finalSignupData ? 'Exists' : 'MISSING');
                    ...
                    >
                        <View style={styles.content}>
                            ...
                            <Text style={styles.subtitle}>
                                ...
                                Please click the link to confirm your seller account.
                            </Text>
