-- Migration: Add warranty columns to products table
-- Created: 2026-03-23
-- Description: Adds warranty tracking columns to existing products table
...
-- Check if order_items table exists before adding columns
DO $$
BEGIN
...
-- ============================================================================
-- STEP 6: Add check constraint for warranty_duration_months
-- ============================================================================
