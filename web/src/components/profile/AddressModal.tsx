...
export const AddressModal = ({
  ...
  const [regionList, setRegionList] = useState<Array<{region_code: string, region_name: string}>>([]);
  const [provinceList, setProvinceList] = useState<Array<{province_code: string, province_name: string}>>([]);
  const [cityList, setCityList] = useState<Array<{city_code: string, city_name: string}>>([]);
  const [barangayList, setBarangayList] = useState<Array<{brgy_code: string, brgy_name: string}>>([]);
