    ...
    return (
        <section className="py-24 px-4 overflow-hidden">
            ...
            >
                ...
                <h2 className="font-fondamento text-7xl md:text-9xl font-extrabold text-[var(--brand-primary)] tracking-tighter mb-8 drop-shadow-sm select-none">
                    BazaarX
                </h2>
                ...
                <motion.p
                    ...
                    className="text-lg md:text-xl text-[var(--text-primary)] max-w-2xl leading-relaxed px-4 mx-auto font-medium"
                >
