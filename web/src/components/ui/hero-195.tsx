...
export function Hero195() {
  return (
    <>
    <section className="bg-gradient-to-br from-orange-50 via-white to-orange-50 py-24 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Your Complete
              <br />
              <span className="text-orange-600">Seller Dashboard</span>
            </h1>
          ...
          <div className="relative">
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-orange-200 rounded-full opacity-50 blur-2xl" />
