      ...
      {(showAddVariantForm || variantConfigs.length === 0) ? (
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-medium text-gray-500">Select {firstAttributeName}</label>
            ...
            <div>
              <label className="text-xs font-medium text-gray-500">Select {secondAttributeName}</label>
          ...
          <div className="flex justify-end gap-2">
            <Button
              ...
              className={variantConfigs.length === 0 ? "opacity-50 cursor-not-allowed" : ""}
            >
              Cancel
            </Button>
            <Button
