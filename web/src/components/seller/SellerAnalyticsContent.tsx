 ...
 * Extracted into its own chunk so recharts (~180KB gzip) is deferred until
 * the Analytics page is first visited instead of being in the main bundle.
 */
...
export default function SellerAnalyticsContent({
    timeRange,
    setTimeRange,
                        ...
                        {metrics.map((metric, index) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-4 relative z-10">
                                    ...
                                    >
                                        <div className="h-5 w-5">{metric.icon}</div>
                                    </div>
                                    <div
                                        className={cn(
                                ...
                                <h3 className="text-[var(--text-muted)] text-sm font-bold uppercase tracking-wide relative z-10">
                                    {metric.title}
                                </h3>
                                <p className="text-2xl font-black text-[var(--text-headline)] font-heading mt-1 relative z-10">
                                    {metric.value}
                                </p>
                            </motion.div>
                        ))}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        >
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    <h3 className="text-xl font-bold text-[var(--text-headline)] font-heading">
                                        Revenue Overview
                                    </h3>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-100">
                                        <th className="text-left py-4 px-4 text-xs font-bold text-[var(--text-muted)] uppercase tracking-wide">
                                            Product
                                        </th>
                                        <th className="text-right py-4 px-4 text-xs font-bold text-[var(--text-muted)] uppercase tracking-wide">
                                            Units Sold
                                        </th>
                                        <th className="text-right py-4 px-4 text-xs font-bold text-[var(--text-muted)] uppercase tracking-wide">
                                            Revenue
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {topProducts.map((product, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-4 text-right text-sm font-medium text-[var(--text-secondary)]">
                                                {product.sold}
                                            </td>
