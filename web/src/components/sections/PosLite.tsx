        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {[
              ...
              { title: 'Unified Order Management', desc: 'All your sales channels in one single dashboard.' },
              { title: 'Instant Offline Recording', desc: 'Sync your inventory in two taps from your phone.' }
            ].map((item, index) => (
              <motion.div 
                key={index}
                whileHover={{ x: 10 }}
