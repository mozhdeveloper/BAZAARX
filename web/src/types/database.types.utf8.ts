...
export type ProductQA = Tables<"qa_submission_batch_items">;
export type ApprovalStatus = Product["approval_status"];
...
export type WarrantyType = Database["public"]["Enums"]["warranty_type_enum"];
...
export type VoucherType = Voucher["voucher_type"];
export type InventoryLedger = Tables<"inventory_movements">;
...
export type VacationReason = string;
