...
export const categories: Category[] = [
  ...
  { id: '5', name: 'Beauty & Personal Care', icon: 'https://images.verifiedmarketresearch.com/assets/Top-7-personal-care-product-companies-empowering-beauty-and-enhancing-well-being.jpg', count: 876 },
  { id: '6', name: 'Books', icon: 'https://collegeinfogeek.com/wp-content/uploads/2018/11/Essential-Books.jpg', count: 654 },
  { id: '7', name: 'Music & Instruments', icon: 'https://www.ensembleschools.com/the-inside-voice/wp-content/uploads/sites/47/2023/11/shutterstock_1079712752.jpg', count: 432 },
  { id: '8', name: 'Sports & Fitness', icon: 'https://img.freepik.com/free-photo/sports-tools_53876-138077.jpg?semt=ais_hybrid&w=740&q=80', count: 321 },
  { id: '9', name: 'Baby & Kids', icon: 'https://media.istockphoto.com/id/1435512685/photo/childrens-things-hang-on-a-hanger-in-a-clothing-store.jpg?s=612x612&w=0&k=20&c=14YFAd0nE0yTll8O6gmqpGIa8cfk_I2LsyISDAyL9G8=', count: 543 },
  { id: '10', name: 'Automotive', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzP1IHcPzRNn_8IiizfTCYpjMbjN17Vlb1wQ&s', count: 234 }
];