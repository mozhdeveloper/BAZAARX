      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-2 md:p-8 flex-1 w-full h-full overflow-auto relative z-10 scrollbar-hide">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative group">
                  <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-[var(--brand-primary)] transition-colors" />
                  <Input
                    placeholder="Search notifications..."
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="pl-12 py-5 rounded-xl border-orange-100 bg-gray-50/50 focus:bg-white focus:ring-[var(--brand-primary)] focus:border-[var(--brand-primary)] transition-all"
                  />
                </div>
            ...
            {/* Notifications List */}
            <div className="bg-white rounded-xl border border-orange-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] overflow-hidden">
              {loading ? (
