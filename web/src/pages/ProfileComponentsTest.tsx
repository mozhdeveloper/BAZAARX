...
import type { Address, PaymentMethod, BuyerProfile } from '@/stores/buyerStore';
              ...
              <div className="flex flex-col gap-1 mb-5">
                ...
                <div className="flex items-center justify-center md:justify-start gap-6 mt-4">
                  <div className="flex items-center gap-2">
                    <span className="text-white text-base font-bold">{mockProfile.totalOrders || 0}</span>
                    <span className="text-white/50 text-[10px] font-bold uppercase tracking-widest">Orders</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5">
                      <span className="text-white text-base font-bold">{mockProfile.bazcoins || 0}</span>
        ...
        <Tabs defaultValue="personal" className="-mt-4 space-y-4">
          ...
          <TabsContent value="addresses">
            <AddressManagementSection
              ...
              loading={false}
              onAddressAdded={(addr) => setAddresses([...addresses, addr])}
              onAddressUpdated={(id, updates) => {
          ...
          <TabsContent value="payments">
            <PaymentMethodsSection
              ...
              onAddPaymentMethod={(method) => setPaymentMethods([...paymentMethods, method])}
